...
const getAllPastShipmentActionNames = asyncActionNames('GET_REQUESTED_CARRIER');
...
export default function(state = INITIAL_STATE, action) {
	...
	switch(action.type) {
       case getAllPastShipmentActionNames.success:
        return { ...state, errors: null, authenticated: true, requestedCarriers:action.payload, progress: false };
